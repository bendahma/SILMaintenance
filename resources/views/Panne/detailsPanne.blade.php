                ...
                <form action="{{ route('machine.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" readonly name="matricule" id="" class="form-control" placeholder="Matricule" value="{{ isset($machine) ? $machine->immatriculation : '' }}">
                        </div>
                        <div class="col">
                            <label for="">N° Serie</label>
                            <input type="text" readonly name="matricule" id="" class="form-control" placeholder="Matricule" value="{{ isset($machine) ? $machine->numeroSerie : '' }}">
                        </div>
                        <div class="col">
